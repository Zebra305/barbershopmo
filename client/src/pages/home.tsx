...
import { Star, Scissors, Crown, MapPin, Phone, Mail, Clock, LogOut } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Welcome Message */}
      <div className="bg-barber-gold text-center py-2">
        <p className="text-barber-dark font-medium">
          {t("welcome.message", { name: user?.firstName || "User" })}
        </p>
      </div>
      ...
      <div className="fixed bottom-4 right-4 flex flex-col space-y-2">
        {user?.isAdmin && (
          <Button
            onClick={() => (window.location.href = "/baas")}
        ...
        <Button
          ...
          variant="outline"
          className="bg-white border-barber-gold text-barber-dark hover:bg-barber-gold"
        >
