...
echo ""
echo -e "${YELLOW}Integration with existing setup:${NC}"
echo "Copy the barbershop services from docker-compose-standalone.yml"
echo "to your main /root/docker-compose.yml file and run:"
echo "docker-compose up -d barbershop barbershop_db"